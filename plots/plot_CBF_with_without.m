...
plot(t_with, y_e_with, 'b', 'LineWidth', 1.5, 'DisplayName', 'Cross-track error y_e with CBF');
plot(t_without, y_e_without, '-', 'LineWidth', 1.5, 'DisplayName', 'Cross-track error y_e without CBF');
